<?php
    ...
    if(isset($_GET['supprimer'])){
        ...
        if(isset($opt)){
            ...
            $option = $opt[0];
            if($option == "ajouter"){
                include('php/view/home/ajouter.php');
            }else if($option == "modifier"){
                require_once('php/classe/classeHome.php');

                include('php/view/home/modifier.php');
            }else if($option=="supprimer"){
               require_once('php/classe/classeHome.php');

                include('php/view/home/liste.php');
            }
            else if($option=="details"){
                include('php/view/home/details.php');
