                            ...
                            <div class="form-group">
                                <label>Categorie</label>
                                    ...
                                    <option value="" selected disabled>-Choisir-</option>
                                        ...
                                        ?>
                                            <option <?php if ($valueCategorie['id'] == $valueArticle['categorie']) echo 'selected' ?>  value="<?php echo $valueCategorie['id']; ?>"><?php echo $valueCategorie['libelle']; ?></option>
                                        <?php  }
                                        ?>
                                    </select>
                            </div>
                  ...
                  <!-- <footer class="blockquote-footer"> -->
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <button class="btn btn-light " onclick="location.href='article_liste';" >Annuler</button>
