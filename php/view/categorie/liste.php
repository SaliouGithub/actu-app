...
<div class="col-lg-12 grid-margin stretch-card">
  <div class="card">
    <div class="card-body">
      <h3 class="font-weight-bold">Liste des catégories</h3>
              ...
              echo '
                            <tr id="' . $value['id'] . '">
                                ...
                                <td>
                                    ...
                                    <button onclick="window.location.href = \'categorie_modifier-'.$value['id'].'\';"  type="button" class="btn btn-dark btn-rounded btn-icon" data-toggle="modal" data-target="#exampleModal">
    ...
    swal({
      ...
      if (willDelete) {
        ...
        $.ajax({
          type: "GET",
          url: "php/controller/categorie.php?supprimer=" + idElement,
          data: $(this).serialize(),
